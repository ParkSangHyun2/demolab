				...
				<td>
					<div class="tdCell">
						...
						<div id="modify_phone" style="display: none;">
							<form
								action="${pageContext.request.contextPath}/memberProfile/modify"
								method="post">
								<p>
						...
						<button id="modify_phone_btn" type="button" class="btn btn-primary btn-xs"
			...
			<tr>
				...
				<td>
					<div class="tdCell">
						...
						<button id="nickName_modify_btn" type="button" class="btn btn-primary btn-xs"
			...
			<tr>
				...
				<td>
					<div class="tdCell">
						...
						<button id="birthDay_modify_btn" type="button" class="btn btn-primary btn-xs"
